...
usr="xxxxxxx" #Username
pas="xxxxxxx" #password
...
username = wd.find_element("id", 'email')
username.send_keys(usr) 
sleep(0.5)

# locate password form by_class_name
passw = wd.find_element("id", 'pass')
passw.send_keys(pas)
sleep(0.5)

# locate submit button by_xpath
sign_in_button = wd.find_element("xpath", '//*[@type="submit"]')
...
for i in range(0,len(keyword)):
    ...
    if (hasXpath('//div[@class="_4f38"]/div/a[4]')):
        allp=wd.find_elements("xpath", '//div[@class="_4f38"]/div/a[4]')
        ...
        if(hasXpath('//div[@class="_6-cp"]')):
            posts=wd.find_elements("xpath", '//div[@class="_6-cp"]/div/span/a')
            ...
            for p in html:
                ...
                if hasXpath('//div[@class="_6a _5u5j _6b"]/h5/span/span/a'):    
                    name=wd.find_element("xpath", '//div[@class="_6a _5u5j _6b"]/h5/span/span/a')
                ...
                if hasXpath('//span[@class="fsm fwn fcg"]/a/abbr/span'):
                    date=wd.find_element("xpath", '//span[@class="fsm fwn fcg"]/a/abbr/span')
                ...
                if hasXpath('//span[@class="_81hb"]'):
                    likes=wd.find_element("xpath", '//span[@class="_81hb"]')
                ...
                if hasXpath('//a[@class="_3hg- _42ft"]'):
                    comments=wd.find_element("xpath", '//a[@class="_3hg- _42ft"]')
                ...
                if hasXpath('//a[@class="_3rwx _42ft"]'):
                    shares=wd.find_element("xpath", '//a[@class="_3rwx _42ft"]')
                ...
                if hasXpath('//div[@class="_5pbx userContent _3576"]'):
                    final_post=wd.find_element("xpath", '//div[@class="_5pbx userContent _3576"]')
                    ...
                    final_post=wd.find_element("xpath", '//div[@class="_5pbx userContent _3ds9 _3576"]')
                    post_text = final_post.text.encode("utf-8")
                    f.write(post_text)
                    f.write(("\n \n").encode('ascii'))
                    f.write("--------------------------------------------------------------------******************------------------------------------------------------------".encode('ascii'))
